  function info = getInfoFromTxt_0712(fn)
% 
% fn='C:\Users\Tingting\Google Drive\data_roomF\210714_756_10-48-51.txt';
        if exist([fn(1:end-4) '_info.mat'])
            load([fn(1:end-4) '_info.mat']);
        else
           Info = [];
        end
        ...
        if exist('LaserTrial')
            ...
            if nanmax(info.LaserON)==1
                if ~isempty(Info)
                    ...
                    info.OptoDesign=Info.OptoDesign;
            ...
            elseif contains(animalID,'TT01') || contains(animalID,'TT08') || contains(animalID,'TT10') || contains(animalID,'2041')|| contains(animalID,'2032')|| contains(animalID,'745')|| contains(animalID,'3122')
