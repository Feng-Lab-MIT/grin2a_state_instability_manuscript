...
load('SSFO_revision.mat');

%%
figure; title('SSFO')
data=SSFO_OFF;
IDs={'3462_1','3462_2','10694_9','10694_10','5962_5','5982_7','5982_6'}; %Mutant ID
%IDs={'5962_4','5962_7','10692_6','5982_5','5982_3'}; %WT ID
...
Y_SSFO_OFF_1=smoothdata(Y_SSFO_OFF_1,2,'gaussian',1);
% plot
...
%
Y_SSFO_ON_1=smoothdata(Y_SSFO_ON_1,2,'gaussian',1);
...
Y=HR_LR_bs_list_temp;
 ...
 AnimalID=ID;
    ...
    for i=1:length(data)
        if ~isempty(data{i})
     if contains(data{i}.File,AnimalID)
