    ...
    methods
        ...
        function obj = spikes2(varargin)
            ...
            if nargin < 1
                ...
                obj.nchannels = 4;%session_info.nchannels{n}(tetrode);
                ...
                switch session_info.filetype{n}
                    ...
                    case 'laser event file jakob'
                        ...
                        if obj.nchannels == 4 % tetrode case
                            ...
                            fname = [data_folder filesep 'Sc' tetrode '.ntt'];
                        
                        else % stereotrode case
                            fname = [data_folder filesep 'Sc' tetrode '.nst'];
                        end
                        ...
                        obj.waveforms = data.waveforms;
                         ...
                         obj.folder = [data_folder filesep 'Sc' tetrode '.cut'];
                    ...
                    case 'Neuralynx G'
                        ...
                        if obj.nchannels == 4 % tetrode case
                            ...
                            fname = [data_folder filesep tetrode '.ntt']
                        
                        else % stereotrode case
                            fname = [data_folder filesep tetrode '.nst'];
                        end
                        ...
                        obj.waveforms = data.waveforms;
                         ...
                         obj.folder = [data_folder filesep tetrode '.cut'];
        ...
        function obj2 = cluster(obj,cluster_n,varargin)
           ...
           % if strcmp(obj.folder(end-3:end),'.cut')
                ...
                %if find(cluster_info==cluster_n)>0 %%edited by Tingting
                cl.id = find(cluster_info == cluster_n)-1;
                %else %% edited by Tingting
                 %   cl.id=[1:10]; %% edited by Tingting
                %end    % edited by Tingting
