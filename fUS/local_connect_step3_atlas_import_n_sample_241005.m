...
VIsoCortex=niftiread('\\Fenglab03\Yiyun\20230410_fUS_seedmap\regions\315_Isocortex.nii\315_Isocortex.nii');
VTH=niftiread('\\Fenglab03\Yiyun\20230410_fUS_seedmap\regions\549_TH.nii\549_TH.nii');



%%
vqIsoCortex=Resample(VIsoCortex);
vqTH=Resample(VTH);



%%
save('\\Fenglab03\Yiyun\20230410_fUS_seedmap\region_atlas_newly_sample_v5_241005resam_newreg.mat','vqTH','vqIsoCortex');
