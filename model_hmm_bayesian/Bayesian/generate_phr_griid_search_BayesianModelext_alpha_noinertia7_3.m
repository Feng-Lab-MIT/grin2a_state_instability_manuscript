...
noisyfactorhrlist=[0.5,0.9,1,2,3,4,1.5,2.5,3.5]; %6
...
load('PHR_grin_search_coarse_exp_alphamore231208_v7noisymore.mat','PHR_Large_mean','PHR_Large_all');
%%

for m=1
    for k=6 %1:7 %8:9 %1:9 %hr std 0
       for l=5:6 %1:5 %lr std 
          for i = 1:15 %1:7 %8:9 %alpha
             for j = 7:9 %6 %1:6 %noisyfactor
                ...
                save('PHR_grin_search_coarse_exp_alphamore231208_v7_3noisymore.mat')
