...
load('\\fenglab03\yiyun\20240615 new model for revision\NLLcon_finmin_wt_v5_20240707.mat',"bestparams");
...
nblock=500;
[actions,pressn,state]=generate_simulate_rl(alpha,hr_m0,nblock);
...
load('\\fenglab03\yiyun\20221031 new data_and_model\Sum_Data_Seperate_Animals_allcellsflat.mat','WT_sub_allcells');
...
%save(strcat('generated_data_wr','.mat'));
%clearvars
