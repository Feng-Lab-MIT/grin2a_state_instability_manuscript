...
load('\\fenglab03\yiyun\20241221 manuscript_code_upload\model_hmm_bayesian\Bayesian\Sum_Data_Seperate_Animals_allcellsflat.mat','WT_sub_allcells');
...
%%
%load("Z:\20231027 lever pressing paper figure\Bayesian\20231101 bayesian model\phr_grid_search_combined_sub_v7_20231214.mat","PHR_Large_mean_combined",'alphalist','noisyfactorlist','hr_std0list','lr_stdlist');
...
%%
save(strcat('NLLcon_finmin_wt_bayesian_v5_20240707','.mat'));
clearvars output